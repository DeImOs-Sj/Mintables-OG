...
function Button() {
    ...
    const connectToMetaMask = async () => {
        try {
            ...
            // Navigate to Puzzle Gallery after connecting
            navigate('/puzzle-gallery');
        } catch (error) {
